...
spa.shell = (function () {
  ...
  var
    configMap = {
      ...
      + '<div class="content">'
      +   '<h2 class="content-head is-center">Sign up now.  Help preserve historical images.</h2>'
      +   '<div class="pure-g">'
      ...
      +         'as many helping hands as we can fine.  If the preservation of historical '
      ...
      +         'Historical Societies in Indiana, along with Saint Joseph\'s College.'
      +       '</p>'
      +     '</div>'
      +   '</div>'
